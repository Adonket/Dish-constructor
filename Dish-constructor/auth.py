...
class AdaptiveMobileLoginApp:
    def __init__(self):
        ...
        self.root.configure(bg='#E3F2FD')  # Светло-голубой фон для всего окна

        # Получаем размер экрана
        self.screen_width = self.root.winfo_screenwidth()
        self.screen_height = self.root.winfo_screenheight()

        # Устанавливаем размер окна (80% от экрана, но не менее 300x500 и не более 500x800)
        ...
        self.root.minsize(300, 500)  # Минимальный размер
    ...
    def setup_scaling_factors(self):
        ...
        # Базовые размеры для reference (360x640 - типичный мобильный)
        self.base_width = 360
    ...
    def create_widgets(self):
        ...
        # Создаем эффект тени с помощью нескольких рамок
        ...
        # Фрейм для поля ввода логина с эмодзи
        ...
        # Фрейм для поля ввода пароля с эмодзи
        ...
        # Скругленная кнопка Вход цвета индиго
    ...
    def toggle_password(self):
        ...
        if self.password_visible:
            ...
            self.eye_btn.config(text=" ⌣ ")  # Обезьяна с закрытыми глазами
            self.password_visible = False
        else:
            # Показать пароль
            self.password_entry.config(show="")
            self.eye_btn.config(text="👁")  # Открытые глаза
